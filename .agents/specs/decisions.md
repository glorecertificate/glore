...
| ---------- | ----------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-03-22 | Migrated from `ship` skill workflow to superpowers workflow                                           | The superpowers skills (obra/superpowers) provide a more composable and performant development workflow. `ship` is retained locally but no longer tracked in git. Project docs moved to `.agents/specs/`, plans go to `.agents/plans/`. AGENTS.md updated to encode the full superpowers chain with location overrides. |
