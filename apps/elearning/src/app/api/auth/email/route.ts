...
import { EMAIL_TEMPLATES, type EmailTemplate, sendEmail } from '@/lib/services/mailer'
...
export const POST = async (request: NextRequest) => {
  ...
  if (!EMAIL_TEMPLATES.includes(template)) return NextResponse.json('Invalid action', { status: 400 })
