...
import { useReadOnly, type PlateElementProps, type RenderNodeWrapper } from 'platejs/react'
...
const TodoMarker = (props: PlateElementProps) => {
  ...
  return (
    <div contentEditable={false}>
      <Checkbox className={cn('-left-6 absolute top-1', readOnly && 'pointer-events-none')} {...checkboxProps} />
    </div>
  )
}
