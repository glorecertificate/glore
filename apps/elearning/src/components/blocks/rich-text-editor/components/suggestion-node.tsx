...
import { PlateLeaf, type PlateLeafProps, type RenderNodeWrapper, useEditorPlugin, usePluginOption } from 'platejs/react'

import { cn } from '@/lib/utils'
import { type SuggestionConfig, suggestionPlugin } from '../plugins/suggestion'
...
const SuggestionLineBreakContent = ({ suggestionData }: { suggestionData: TSuggestionData }) => {
