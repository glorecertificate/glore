...
export const Input = ({
  ...
  return (
    <div className={cn('relative', disabled && 'cursor-not-allowed')}>
      ...
      <Label
        className={cn(
          'peer-placeholder-shown:-translate-y-2 peer-focus:-translate-y-5 peer-[:not(:placeholder-shown)]:-translate-y-5 absolute top-2 left-1.5 origin-[0] transform bg-transparent px-2 font-normal text-muted-foreground transition-[scale,top,translate] duration-[180ms] peer-placeholder-shown:top-[18.5px] peer-placeholder-shown:scale-100 peer-placeholder-shown:cursor-text peer-focus:pointer-events-none peer-focus:top-2 peer-focus:scale-95 peer-focus:bg-background peer-focus:text-foreground peer-[:not(:placeholder-shown)]:pointer-events-none peer-[:not(:placeholder-shown)]:top-2 peer-[:not(:placeholder-shown)]:scale-95 peer-[:not(:placeholder-shown)]:bg-background peer-[:not(:placeholder-shown)]:peer-aria-invalid:text-destructive peer-focus:peer-aria-invalid:text-destructive peer-placeholder-shown:peer-aria-invalid:text-destructive/60',
