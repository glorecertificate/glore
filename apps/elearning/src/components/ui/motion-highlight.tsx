...
export const MotionHighlight = <T extends string>({ ref, ...props }: MotionHighlightProps<T>) => {
  ...
  const { boundsOffset, containerClassName } = props as ParentModeMotionHighlightProps
  ...
  const render = useCallback(
    ...
    [mode, boundsState, transition, exitDelay, className, activeClassNameState, containerClassName]
  )
