    ...
    <DropdownMenu modal={false} onOpenChange={setOpen} open={open} {...props}>
      ...
      <DropdownMenuContent align="start">
        <DropdownMenuGroup>
          ...
          <DropdownMenuItem onSelect={exportToPdf}>{t('actions.exportAsPdf')}</DropdownMenuItem>
          <DropdownMenuItem onSelect={exportToImage}>{t('actions.exportAsImage')}</DropdownMenuItem>
          <DropdownMenuItem onSelect={exportToMarkdown}>{t('actions.exportAsMarkdown')}</DropdownMenuItem>
        </DropdownMenuGroup>
      </DropdownMenuContent>
    </DropdownMenu>
  )
