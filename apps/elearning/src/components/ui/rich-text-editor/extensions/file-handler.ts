...
import { filterFiles, type FileError, type FileValidationOptions } from '@/components/ui/rich-text-editor/utils'
...
export const FileHandlePlugin = (options: FileHandlePluginOptions) => {
  const { allowedMimeTypes, editor, key, maxFileSize, onDrop, onPaste, onValidationError } = options
