...
import { lessonQuery, parseLesson } from './lesson'
...
export const selectCourse = async (client: DatabaseClient) => client.from('courses').select(courseQuery).single()

export const parseCourse = (data: QueryData<ReturnType<typeof selectCourse>>) => {
