...
import { organizationQuery, parseOrganization } from './organization'
...
export const selectUser = (client: DatabaseClient) => client.from('users').select(userQuery).single()

export const parseUser = (data: QueryData<ReturnType<typeof selectUser>>) => {
