...
CREATE POLICY "Allow any user to insert user_locales" ON "public"."user_locales" FOR insert TO "authenticated",
"anon"
WITH
  CHECK (TRUE);

CREATE POLICY "Allow any user to read user_locales" ON "public"."user_locales" FOR
SELECT
  TO "authenticated",
  "anon" USING (TRUE);

CREATE POLICY "Allow any user to update user_locales" ON "public"."user_locales"
FOR UPDATE
  TO "authenticated",
  "anon" USING (TRUE)
WITH
