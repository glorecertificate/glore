...
comment ON type "public"."role" IS 'Role of an user in the organization';
...
comment ON TABLE "public"."skill_groups" IS 'Areas grouping soft skills';
...
ADD CONSTRAINT "courses_description_key" UNIQUE ("description");
