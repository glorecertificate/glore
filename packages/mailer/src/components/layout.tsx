...
import { type EmailOptions } from '@glore/mailer/types'

export interface LayoutProps extends HtmlProps, Partial<EmailOptions> {
...
export const Layout = ({
  ...
  <Html lang={locale} title={subject} {...props}>
    <Head>{head}</Head>
    <Tailwind config={{ presets: [pixelBasedPreset], theme: { extend: deepMerge(mailer.theme, tailwindConfig) } }}>
