...
import { requestOrganizationRegistration } from '@/actions/organizations/requests'
...
export const RegisterForm = () => {
  ...
  return submitted ? (
    <div className="flex flex-col items-center gap-8 rounded-lg border p-8 text-center">
