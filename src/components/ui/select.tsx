...
export const SelectTrigger = ({
  ...
  <SelectPrimitive.Trigger
    className={cn(
      ...
      'hover:not-disabled:bg-accent/50 focus-visible:not-disabled:border-ring focus-visible:not-disabled:ring-[3px] focus-visible:not-disabled:ring-ring/50',
      "disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive not-disabled:aria-invalid:ring-destructive/20 data-placeholder:text-muted-foreground *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 dark:bg-input/30 hover:dark:not-disabled:bg-input/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-muted-foreground [&>span]:line-clamp-1",
      className
    )}
